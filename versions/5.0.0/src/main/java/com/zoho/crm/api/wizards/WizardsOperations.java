...
public class WizardsOperations
{
	...
	public APIResponse<ResponseHandler> getWizards() throws SDKException
	{
		...
		apiPath = apiPath.concat("/crm/v4/settings/wizards");
	 ...
	 * @param wizardId A Long representing the wizardId
	 * @param paramInstance An instance of ParameterMap
	 * @return An instance of APIResponse<ResponseHandler>
	 * @throws SDKException
	 */
	public APIResponse<ResponseHandler> getWizardById(Long wizardId, ParameterMap paramInstance) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
