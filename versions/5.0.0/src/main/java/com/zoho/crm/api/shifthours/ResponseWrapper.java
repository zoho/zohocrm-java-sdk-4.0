...
public class ResponseWrapper implements Model, ResponseHandler
{
	 ...
	 * @return An instance of List<ShiftHour>
	 */
	public List<ShiftHour> getShiftHours()
	{
	 ...
	 * @param shiftHours An instance of List<ShiftHour>
	 */
	public void setShiftHours(List<ShiftHour> shiftHours)
	{
