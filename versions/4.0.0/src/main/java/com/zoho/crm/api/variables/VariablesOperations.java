...
public class VariablesOperations
{
	...
	public APIResponse<ResponseHandler> getVariables(ParameterMap paramInstance) throws SDKException
	{
		...
		apiPath = apiPath.concat("/crm/v4/settings/variables");
	...
	/**
	 * The method to create variable
	 * @param request An instance of BodyWrapper
	 * @return An instance of APIResponse<ActionHandler>
	 * @throws SDKException
	 */
	public APIResponse<ActionHandler> createVariable(BodyWrapper request) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
