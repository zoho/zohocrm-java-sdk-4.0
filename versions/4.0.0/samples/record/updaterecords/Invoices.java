...
public class Invoices {
	public static void updateInvoices(String module) throws Exception
	{
		...
		record1.setId(3345498598275042L);
...
//		accountname.addFieldValue(Field.Accounts.ID, 440248884001L);
		...
		record1.addFieldValue(Field.Invoices.DEAL_NAME, dealname);
		...
		ArrayList<com.zoho.crm.api.record.Record> inventoryLineItemList3 = new ArrayList<com.zoho.crm.api.record.Record>();
		...
		lineItemProduct3.setId(440248954344L);
...
//		inventoryLineItem3.addKeyValue("Product_Category_1", "hardware");
		...
		record1.addFieldValue(Field.Invoices.INVOICED_ITEMS, inventoryLineItemList3);
