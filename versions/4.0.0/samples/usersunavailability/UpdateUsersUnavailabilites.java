...
public class UpdateUsersUnavailabilites
{
	public static void updateUsersUnavailabilites() throws Exception
	{
		...
		OffsetDateTime from = OffsetDateTime.of(2022, 8, 02, 11, 00, 01, 00, ZoneOffset.of("+05:30"));
		user1.setFrom(from);
		OffsetDateTime to = OffsetDateTime.of(2022, 9, 05, 11, 00, 01, 00, ZoneOffset.of("+05:30"));
		user1.setTo(to);
		User user = new User();
