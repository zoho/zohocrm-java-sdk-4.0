...
import com.zoho.crm.api.associateemail.SUCCESS;
import com.zoho.crm.api.associateemail.To;
import com.zoho.crm.api.associateemail.Wrapper;
...
public class Associate {
	public static void associate(Long recordId, String module) throws Exception{
		...
		for (int i=0; i<1; i++) {
			...
			associateEmail.setOriginalMessageId("c6085fae06cbd7b75001d81a0149bbe5cff03fe");
...
//			associateEmail.setDateTime(OffsetDateTime.of(2023, 05, 9, 11, 26, 25, 00, ZoneOffset.of("+05:30")));
			associateEmail.setSent(new Choice<Boolean>(true));
			// associateEmail.setContent("this is content!");
			...
			attachment.setId("c608efab46b788e6ceb74969cca78f9b7708bc951ab");
