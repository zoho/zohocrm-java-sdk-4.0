...
import com.zoho.crm.api.businesshours.BusinessHoursCreated;
...
public class UpdateBusinessHours {
	...
	{
		BusinessHoursOperations businessHoursOperations = new BusinessHoursOperations("440248020813");
		BodyWrapper request = new BodyWrapper();
		BusinessHours businessHours = new BusinessHours();
		businessHours.setId(4402481017425L);
		businessHours.setSameAsEveryday(false);
		List<Choice<String>> businessdays = new ArrayList<>();
...
//		businessdays.add(new Choice<String>("Thursday"));
//		businessdays.add(new Choice<String>("Friday"));
		...
		List<String> businessTiming = new ArrayList<>();
		...
		List<String> businessTiming1 = new ArrayList<>();
		...
		List<String> businessTiming2 = new ArrayList<>();
		businessTiming2.add("11:00");
		businessTiming2.add("17:00");
		bhct2.setBusinessTiming(businessTiming2);
		//
		List<BreakHoursCustomTiming> customTiming= new ArrayList<>();
