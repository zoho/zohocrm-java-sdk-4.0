...
public class UpdateMapDependency
{
	public static void updateMapDependency(Long layoutId, String module, Long dependencyId) throws Exception
	{
		...
		picklistMap.setId(3652397003391l);
	...
	public static void main(String[] args)
	{
		try
		{
			...
			updateMapDependency(layoutId, moduleAPIName, dependencyId);
		}
		catch (Exception e)
		{
			e.printStackTrace();
