...
public class ModulesOperations
{
	...
	public APIResponse<ResponseHandler> getModules(HeaderMap headerInstance) throws SDKException
	{
		...
		apiPath = apiPath.concat("/crm/v4/settings/modules");
	 ...
	 * @return An instance of APIResponse<SingleResponseHandler>
	 * @throws SDKException
	 */
	public APIResponse<SingleResponseHandler> getModuleByAPIName(String apiName) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
		...
		return handlerInstance.apiCall(SingleResponseHandler.class, "application/json");
	 ...
	 * @throws SDKException
	 */
	public APIResponse<SingleResponseHandler> getModule(Long id) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
	 ...
	 * @throws SDKException
	 */
	public APIResponse<ActionHandler> updateModule(Long id, BodyWrapper request) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
