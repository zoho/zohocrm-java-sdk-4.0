...
import com.zoho.crm.api.currencies.CurrencyFormat;
...
{
	/**
	 * <h3>Get Currencies</h3> This method is used to get all the available currencies in your organization.
	 * 
	 * @throws Exception
	 */
			...
			if (response.isExpected())
			{
				...
				if (responseHandler instanceof BodyWrapper)
				{
					...
					for (com.zoho.crm.api.currencies.Currency currency : currenciesList)
					{
						...
						CurrencyFormat format = currency.getFormat();
	...
	/**
	 * <h3>Add Currencies</h3> This method is used to add new currencies to your organization.
	 * 
	 * @throws Exception
	 */
	public static void addCurrencies() throws Exception
	{
		...
		// Call createCurrencies method that takes BodyWrapper instance as parameter
		APIResponse<ActionHandler> response = currenciesOperations.createCurrencies(bodyWrapper);
	...
	/**
	 * <h3>Update Currencies</h3> This method is used to update currency details.
	 * 
	 * @throws Exception
	 */
...
//		currency.setPrefixSymbol(true);
	...
	/**
	 * <h3>Enable Multiple Currencies</h3> This method is used to enable multiple currencies for your organization.
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * <h3>Update Currency</h3> This method is used to update base currency details.
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * <h3>Get Currency</h3> This method is used to get the details of a specific currency.
	 * 
	...
	/**
	 * <h3>Update Currency</h3> This method is used to update currency details.
	 * 
	 * @param currencyId - Specify the unique ID of the currency.
	 * @throws Exception
	 */
