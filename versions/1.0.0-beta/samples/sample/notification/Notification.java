...
{
	/**
	 * <h3>Enable Notifications</h3> This method is used to Enable Notifications and print the response.
	 * 
	 * @throws Exception
	 */
	public static void enableNotifications() throws Exception
	{
		...
		notification.setChannelId(168211l);
		...
		notification.setToken("TOKEN_FOR_VERIFICATION_OF_1682");
		...
		// Set channel Id of the Notification
		notification2.setChannelId(168211l);
		...
		// To ensure that the notification is sent from Zoho CRM, by sending back the given value in notification URL body.
		// By using this value, user can validate the notifications.
		notification2.setToken("TOKEN_FOR_VERIFICATION_OF_1682");
	...
	/**
	 * <h3>Get Notification Details</h3> This method is used to get all the Notification and print the response.
	 * 
	 * @throws Exception
	 */
	public static void getNotificationDetails() throws Exception
	{
		...
		paramInstance.add(GetNotificationDetailsParam.CHANNEL_ID, 168211l);
	...
	/**
	 * <h3>Update Notifications</h3> This method is used to update Notifications and print the response.
	 * 
	 * @throws Exception
	 */
...
//		notification.setChannelId(168211l);
	...
	/**
	 * <h3>Update Specific Information of a Notification</h3> This method is used to update single Notification and print the response.
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * <h3>Disable Notifications</h3> To stop all the instant notifications enabled by the user for a channel.
	 * 
	...
	{
		// example
		// ArrayList<Long> channelIds = new ArrayList<Long>(Arrays.asList(347706152081l));
	...
	/**
	 * <h3>Disable Specific Notifications</h3> This method is used to disable notifications for the specified events in a channel.
	 * 
	 * @throws Exception
	 */
