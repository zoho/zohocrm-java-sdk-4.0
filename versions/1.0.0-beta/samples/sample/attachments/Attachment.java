...
{
	/**
	 * <h3>Get Attachments</h3> This method is used to get a single record's attachments' details with ID and print the response.
	 * 
	 * @throws Exception
...
//		paramInstance.add(GetAttachmentsParam.IDS, 3477061166611l);
	...
	/**
	 * <h3>Upload Attachments</h3> This method is used to upload an attachment to a single record of a module with ID and print the response.
	 * 
	 * @throws Exception
	 * @param moduleAPIName    The API Name of the record's module
...
//		String absoluteFilePath = "/Users/use_name/Desktop/image.png";
	...
	/**
	 * <h3>Delete Attachments</h3> This method is used to Delete attachments to a single record of a module with ID and print the response.
	 * 
	 * @param moduleAPIName The API Name of the record's module
...
//		String moduleAPIName = "Leads";
//		Long recordId = 347706151772l;
//		List<Long> attachmentIds = new ArrayList<Long>(Arrays.asList(347706159791l, 347706159683, 34770615961010l));
	...
	/**
	 * <h3>Download Attachment</h3> This method is used to download an attachment of a single record of a module with ID and attachment ID and write the file in the specified destination.
	 * 
	 * @throws Exception
	 * @param moduleAPIName     The API Name of the record's module
...
//		String destinationFolder = "/Users/user_name/Desktop";
	...
	/**
	 * <h3>Delete Attachment</h3> This method is used to delete an attachment to a single record of a module with ID and print the response.
	 * 
	 * @param moduleAPIName The API Name of the record's module
	 * @param recordId      The ID of the record to delete attachment
...
//		String moduleAPIName = "Leads";
//		Long recordId = 347706151772;
//		Long attachmentId = "347706151772";
	...
	/**
	 * <h3>Upload Link Attachments</h3> This method is used to upload link attachment to a single record of a module with ID and print the response.
	 * 
	 * @param moduleAPIName The API Name of the record's module
...
//		String moduleAPIName = "Leads";
//		Long recordId = "347706151772";
//		String attachmentURL = "https://5.imimg.com/data5/KJ/UP/MY-8655440/zoho-crm-5x5.png";
