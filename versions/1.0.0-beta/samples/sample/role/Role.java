...
public class Role
{
		...
		if (response != null)
		{
			...
			if (response.isExpected())
			{
				...
				if (responseHandler instanceof BodyWrapper)
				{
					...
					{
						com.zoho.crm.sample.role.Role.getRole(role.getId());
						...
						com.zoho.crm.api.users.MinifiedUser forecastManager = role.getForecastManager();
						...
						com.zoho.crm.api.users.MinifiedUser reportingTo = role.getReportingTo();
	...
	public static void createRoles() throws Exception
	{
		...
		role.setName("SDK Product Manager");

		MinifiedUser reportingTo = new MinifiedUser();

		reportingTo.setId(3477061265l);
	...
	public static void updateRoles() throws Exception
	{
		...
		role.setId(3477061166894l);

		// Set name of the Role
		role.setName("Java SDK Product Manager321123");
	...
	public static void deleteRole(Long roleId) throws Exception
	{
		...
		paramInstance.add(DeleteRoleParam.TRANSFER_TO_ID, 3477061268l);
