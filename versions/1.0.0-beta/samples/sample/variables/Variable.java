...
import com.zoho.crm.api.variables.VariablesOperations.GetVariableByAPINameParam;
...
public class Variable
{
	...
	/**
	 * <h3>Get Variables</h3> This method is used to retrieve all the available variables through an API request and print the response.
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * <h3>Create Variables</h3> This method is used to create a new variable in CRM and print the response.
	 * 
	 * @throws Exception
	 */
	public static void createVariables() throws Exception
	{
		...
		variableGroup.setId(347706130891l);
	...
	/**
	 * <h3>Update Variables</h3> This method is used to update details of variables in CRM and print the response.
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * <h3>Delete Variables</h3> This method is used to delete details of multiple variables in CRM simultaneously and print the response.
	 * 
	 * @param variableIds - The List of the Variable IDs to be deleted
	 * @throws Exception
	 */
	public static void deleteVariables(ArrayList<String> variableIds) throws Exception
	{
		// example
		// ArrayList<Long> variableIds = new ArrayList<Long>(Arrays.asList(347706162113l, 347706162111l));
	...
	/**
	 * <h3>Get Variable By Id</h3> This method is used to get the details of any specific variable. Specify the unique ID of the variable in your API request to get the data for that particular variable group.
	 * 
	...
	public static void getVariableById(Long variableId) throws Exception
	{
		...
		paramInstance.add(GetVariableByIDParam.GROUP, "347706130891");// "General"
	...
	/**
	 * <h3>Update Variable By Id</h3> This method is used to update details of a specific variable in CRM and print the response.
	 * 
	...
	/**
	 * <h3>Delete Variable</h3> This method is used to delete details of a specific variable in CRM and print the response.
	 * 
	...
	/**
	 * <h3>Get Variable for API Name</h3> This method is used to get the details of any specific variable. Specify the unique name of the variable in your API request to get the data for that particular variable group.
	 * 
	...
	public static void getVariableForAPIName(String variableName) throws Exception
	{
		...
		paramInstance.add(GetVariableByAPINameParam.GROUP, "General");// "347706130891"

		// Call getVariableForAPIName method that takes variableName and paramInstance as parameter
		APIResponse<ResponseHandler> response = variablesOperations.getVariableByApiname(variableName, paramInstance);
