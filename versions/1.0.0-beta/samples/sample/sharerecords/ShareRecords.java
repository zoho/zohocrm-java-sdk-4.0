...
{
	/**
	 * <h3>Get Shared Record Details</h3> This method is used to get the details of a shared record and print the response.
	 * 
...
//		paramInstance.add(GetSharedRecordDetailsParam.SHAREDTO, 3477061173021l);
	...
	/**
	 * <h3>Share Record</h3> This method is used to share the record and print the response.
	 * 
...
//		sharedWith.addKeyValue("type", "users");
		...
		request.setNotifyOnCompletion(true);
	...
	/**
	 * <h3>Update Share Permissions</h3> This method is used to update the sharing permissions of a record granted to users as Read-Write, Read-only, or grant full access.
	 * 
	...
	public static void updateSharePermissions(String moduleAPIName, Long recordId) throws Exception
	{
		...
		share1.setType(new Choice<String>("public"));
	...
	/**
	 * <h3>Revoke Shared Record</h3> This method is used to revoke access to a shared record that was shared to users and print the response.
	 * 
