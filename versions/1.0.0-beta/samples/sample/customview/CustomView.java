...
import com.zoho.crm.api.customviews.BodyWrapper;
...
import com.zoho.crm.api.customviews.GroupCriteria;
...
{
	/**
	 * <h3>Get CustomViews</h3> This method is used to get the custom views data of a particular module. Specify the module name in your API request whose custom view data you want to retrieve.
	 * 
	...
	/**
	 * This method is used to get the data of any specific custom view of the module. Specify the custom view ID of the module in your API request whose custom view data you want to retrieve.
	 * 
	 * @param moduleAPIName - Specify the API name of the required module.
	...
	public static void getCustomView(String moduleAPIName, Long customViewId) throws Exception
	{
		// example
		// String moduleAPIName = "Leads";
		// Long customViewId = 347706156293;
