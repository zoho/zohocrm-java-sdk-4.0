...
import com.zoho.crm.api.files.ActionHandler;
import com.zoho.crm.api.files.ActionResponse;
import com.zoho.crm.api.files.ActionWrapper;
import com.zoho.crm.api.files.BodyWrapper;
...
import com.zoho.crm.api.files.SuccessResponse;
...
{
	/**
	 * <h3>Upload File</h3> This method is used to upload a file and print the response.
	 * 
	 * @throws Exception
	 */
	public static void uploadFiles() throws Exception
	{
		...
		StreamWrapper streamWrapper = new StreamWrapper("/usr/download.png");

		// Get instance of StreamWrapper class that takes absolute path of the file to be attached as parameter
		StreamWrapper streamWrapper1 = new StreamWrapper("/usr/download.png");

		// Get instance of StreamWrapper class that takes absolute path of the file to be attached as parameter
		StreamWrapper streamWrapper2 = new StreamWrapper("/usr/download.png");
	...
	{
		// example
		// String id = "ae9c7cefa418aeb7563c0dd42b";
