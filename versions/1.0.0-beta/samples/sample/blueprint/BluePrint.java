...
import com.zoho.crm.api.blueprints.ConvertMapping;
import com.zoho.crm.api.blueprints.Escalation;
import com.zoho.crm.api.blueprints.Field;
import com.zoho.crm.api.blueprints.FieldHandler;
import com.zoho.crm.api.blueprints.ModuleMapping;
import com.zoho.crm.api.blueprints.NextTransition;
import com.zoho.crm.api.blueprints.ProcessInfo;
import com.zoho.crm.api.blueprints.Profile;
import com.zoho.crm.api.blueprints.ResponseHandler;
import com.zoho.crm.api.blueprints.ResponseWrapper;
...
{
	/**
	 * <h3>Get Blueprint</h3> This method is used to get a single record's Blueprint details with ID and print the response.
	 * 
	...
	public static void getBlueprint(String moduleAPIName, Long recordId) throws Exception
	{
		...
		// Get instance of BlueprintsOperations Class that takes recordId and moduleAPIName as parameter
		...
		if (response != null)
		{
			...
			if (response.isExpected())
			{
				...
				if (responseHandler instanceof ResponseWrapper)
				{
					...
					com.zoho.crm.api.blueprints.Blueprint bluePrint = responseWrapper.getBlueprint();
					...
					for (Transition transition : transitions)
					{
						...
						List<FieldHandler> fields = transition.getFields();
						...
						for (FieldHandler fieldHandler : fields)
						{
							...
							MinifiedLayout layout = field.getLayouts();
							...
							if (multiModuleLookup != null)
							{
								...
								for(com.zoho.crm.api.fields.ModuleMap module : multiModuleLookup.getModules())
								{
	...
	/**
	 * <h3>Update Blueprint</h3> This method is used to update a single record's Blueprint details with ID and print the response.
	 * 
	 * @param moduleAPIName The API Name of the record's module
	 * @param recordId      The ID of the record to get Blueprint
