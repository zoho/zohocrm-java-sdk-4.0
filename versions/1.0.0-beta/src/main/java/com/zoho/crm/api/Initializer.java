...
public class Initializer
{
	...
	{
		return new StringBuilder().append(Constants.FOR_EMAIL_ID).append(getInitializer().getUser().getEmail()).append(Constants.IN_ENVIRONMENT).append(getInitializer().getEnvironment().getUrl()).append(".").toString();
	}
