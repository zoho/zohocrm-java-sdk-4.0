...
public class AutoNumber implements AutoNumberGroup, Model
{
	private Integer startingNumberLength;
	...
	/**
	 * The method to get the value of startingNumberLength
	 * @return An Integer representing the startingNumberLength
	 */
	public Integer getStartingNumberLength()
	{
	 ...
	 * @param startingNumberLength An Integer representing the startingNumberLength
	 */
	public void setStartingNumberLength(Integer startingNumberLength)
	{
		 this.startingNumberLength = startingNumberLength;

		 this.keyModified.put("starting_number_length", 1);
