...
public class MultiModuleLookup implements MultiModuleLookupGroup, Model
{
	private String fieldLabel;

	private String apiName;

	private List<ModuleMap> modules;
	 ...
	 */
	public List<ModuleMap> getModules()
	{
		return  this.modules;
	 ...
	 * @param modules An instance of List<ModuleMap>
	 */
	public void setModules(List<ModuleMap> modules)
	{
