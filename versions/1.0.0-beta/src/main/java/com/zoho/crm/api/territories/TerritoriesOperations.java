...
public class TerritoriesOperations
{
	...
	public APIResponse<ResponseHandler> getAssociatedUserCount() throws SDKException
	{
		...
		apiPath = apiPath.concat("/crm/v4/settings/territories/actions/associated_users_count");
	...
	/**
	 * The method to get deleted associated territory
	 * @param paramInstance An instance of ParameterMap
	 * @return An instance of APIResponse<RespnseHandler>
	 * @throws SDKException
	 */
	public APIResponse<RespnseHandler> getDeletedAssociatedTerritory(ParameterMap paramInstance) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();

		String apiPath = new String();

		apiPath = apiPath.concat("/crm/v4/settings/territories/actions/deleted_associated_territories");
		...
		return handlerInstance.apiCall(RespnseHandler.class, "application/json");
	...
	public static class GetDeletedAssociatedTerritoryParam
	{
		public static final Param<Long> IDS = new Param<Long>("ids", "com.zoho.crm.api.Territories.GetDeletedAssociatedTerritoryParam");
