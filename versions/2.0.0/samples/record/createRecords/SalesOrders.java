...
public class SalesOrders {
	public static void createSalesOrders(String module) throws Exception
	{
...
//		account.addKeyValue("name", "automated");
		...
		deal_name.addFieldValue(Field.Deals.ID, 32124313234313L);
		...
		contact_name.addFieldValue(Field.Contacts.ID, 323435332143342L);
	...
	//	inventoryLineItem.addKeyValue("Product_Category_1", "hardware");
		...
		inventoryLineItemList.add(inventoryLineItem);
		record1.addFieldValue(Field.Sales_Orders.ORDERED_ITEMS, inventoryLineItemList);
	...
	public static void main(String[] args) {
		try
		{
			...
			createSalesOrders(moduleAPIName);
		}
		catch (Exception e)
		{
			e.printStackTrace();
