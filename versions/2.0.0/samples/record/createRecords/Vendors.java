...
public class Vendors {
	public static void createVendors(String module) throws Exception
	{
		...
		record1.addFieldValue(Field.Vendors.CITY, "city");
		record1.addFieldValue(Field.Vendors.COUNTRY, "country");
		record1.addFieldValue(Field.Vendors.STATE, "state");
		record1.addFieldValue(Field.Vendors.STREET, "street");
		record1.addFieldValue(Field.Vendors.ZIP_CODE, "zipcode");
		record1.addFieldValue(Field.Vendors.DESCRIPTION, "description");
