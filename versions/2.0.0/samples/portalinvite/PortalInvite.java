...
public class PortalInvite {
	...
	{
		PortalInviteOperations portalinviteoperations = new PortalInviteOperations(record, module, userTypeId, type);
		APIResponse<ActionHandler> response = portalinviteoperations.inviteUsers();
		if (response != null)
		{
