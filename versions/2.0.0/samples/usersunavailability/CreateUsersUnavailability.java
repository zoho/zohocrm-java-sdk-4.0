...
{
	public static void createUsersUnavailability() throws Exception
	{
		...
		OffsetDateTime from = OffsetDateTime.of(2022, 06, 02, 11, 00, 01, 00, ZoneOffset.of("+05:30"));
		user1.setFrom(from);
		OffsetDateTime to = OffsetDateTime.of(2022, 07, 02, 11, 00, 01, 00, ZoneOffset.of("+05:30"));
		user1.setTo(to);
		User user = new User();
