...
import com.zoho.crm.api.backup.BodyWrapper;
...
public class Schedule
{
	public static void schedule() throws Exception
	{
		...
		com.zoho.crm.api.backup.Backup backup = new com.zoho.crm.api.backup.Backup();
		backup.setRrule("RRULE:FREQ=MONTHLY;INTERVAL=1;BYDAY=1TH");
		bodyWrapper.setBackup(backup);
		APIResponse<ActionHandler> response = backupOperations.schedule(bodyWrapper);
		if (response != null)
		{
