...
{
	public static void getRelatedEmails(String moduleAPIName, Long id, String type, String index, String ownerId) throws Exception
	{
		...
		APIResponse<ResponseHandler> response = emailTemplatesOperations.getRelatedEmails(paramInstance);
		if (response != null)
		{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			String ownerId = "347773021";
			getRelatedEmails(moduleAPIName, Id, type, index, ownerId);
		}
		catch (Exception e)
		{
			e.printStackTrace();
