...
import com.zoho.crm.api.holidays.HolidaysOperations.DeleteHolidayHeader;
import com.zoho.crm.api.util.APIResponse;
import com.zoho.crm.api.util.Model;

public class DeleteHolidays {
	public static void deleteHolidays(Long id) throws Exception{
		HolidaysOperations holidaysoperations = new HolidaysOperations();
		HeaderMap headerinstance = new HeaderMap();
		headerinstance.add(DeleteHolidayHeader.X_CRM_ORG, "440248020813");
		APIResponse<ActionHandler> response = holidaysoperations.deleteHoliday(id, headerinstance);
		if (response != null)
		{
