...
public class PurchaseOrders {
	public static void updatePurchaseOrders(String module) throws Exception
	{
		...
		vendor_name.addFieldValue(Field.Vendors.ID, 34232534242421L);
		...
		contact_Name.addFieldValue(Field.Contacts.ID, 34520342342321L);
...
//		bodyWrapper.setLarId("3477061087515");
	...
	public static void main(String[] args) {
		try
		{
			...
			updatePurchaseOrders(moduleAPIName);
		}
		catch (Exception e)
		{
			e.printStackTrace();
