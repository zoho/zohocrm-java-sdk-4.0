...
public class UpdateRecord
{
	public static void updateRecord(String moduleAPIName, long recordId) throws Exception
	{
		...
		fileDetail2.setFileId("ae9c7cefa418aec1d6a5cc2d9ab35c326ef5c");
		fileDetails.add(fileDetail2);
		FileDetails fileDetail3 = new FileDetails();
		fileDetail3.setFileId("ae9c7cef4b32b984bad140a629d9f4d4fc8e2");
...
//		inventoryLineItem.addKeyValue("Parent_Id", 5);
		...
		com.zoho.crm.api.record.Record deleteinventoryLineItem = new com.zoho.crm.api.record.Record();
		deleteinventoryLineItem.setId(347710l);
		deleteinventoryLineItem.addKeyValue("_delete", null);
		inventoryLineItemList.add(deleteinventoryLineItem);
