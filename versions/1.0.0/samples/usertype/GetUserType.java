...
import com.zoho.crm.api.usertype.APIException;
import com.zoho.crm.api.usertype.BodyWrapper;
import com.zoho.crm.api.usertype.Fields;
import com.zoho.crm.api.usertype.Filters;
import com.zoho.crm.api.usertype.Layouts;
import com.zoho.crm.api.usertype.Modules;
import com.zoho.crm.api.usertype.Permissions;
import com.zoho.crm.api.usertype.PersonalityModule;
import com.zoho.crm.api.usertype.ResponseHandler;
import com.zoho.crm.api.usertype.UserTypeOperations;
import com.zoho.crm.api.usertype.Views;
import com.zoho.crm.api.util.APIResponse;
import com.zoho.crm.api.util.Model;

public class GetUserType
{
	public static void getUserType(String portalName, Long userTypeId) throws Exception
	{
		UserTypeOperations userTypeOperations = new UserTypeOperations(portalName);
		...
		if (response != null)
		{
			...
			if (response.isExpected())
			{
				...
				if (responseHandler instanceof BodyWrapper)
				{
					...
					List<com.zoho.crm.api.usertype.UserType> userType = responseWrapper.getUserType();
					for (com.zoho.crm.api.usertype.UserType userType1 : userType)
					{
						...
						if (modules != null)
						{
							modules.forEach(module ->
							{
								...
								System.out.println("UserType Modules SharedType: " + module.getSharedType().getValue());
	...
	public static void main(String[] args)
	{
		try
		{
			...
			Long userTypeId = 347706117221008l;
