...
public class Leads {
	public static void updateLeads(String module) throws Exception
	{
		...
		record1.addFieldValue(Field.Leads.SECONDARY_EMAIL, "abc1@zohocom");
