...
public class Cases {
	public static void createCases(String module) throws Exception
	{
		RecordOperations recordOperations = new RecordOperations();
		BodyWrapper bodyWrapper = new BodyWrapper();
		List<com.zoho.crm.api.record.Record> records = new ArrayList<com.zoho.crm.api.record.Record>();
		com.zoho.crm.api.record.Record record1 = new com.zoho.crm.api.record.Record();
		record1.addFieldValue(Field.Cases.SUBJECT, "new Case");
		record1.addFieldValue(Field.Cases.TYPE, new Choice<String>("Question"));
		...
		record1.addFieldValue(Field.Cases.PRODUCT_NAME, product_name);
		record1.addFieldValue(Field.Cases.CASE_ORIGIN, new Choice<String>("Email"));
		record1.addFieldValue(Field.Cases.STATUS, new Choice<String>("On Hold"));
		record1.addFieldValue(Field.Cases.REPORTED_BY, "none");
		record1.addFieldValue(Field.Cases.PHONE, "31231242131");
		com.zoho.crm.api.record.Record contactName = new com.zoho.crm.api.record.Record();
		contactName.addKeyValue("id", 3121012312232L);
		record1.addFieldValue(Field.Cases.RELATED_TO, contactName);
		...
		record1.addFieldValue(Field.Cases.DEAL_NAME, dealName);
		record1.addFieldValue(Field.Cases.DESCRIPTION, "description of case");
		record1.addFieldValue(Field.Cases.INTERNAL_COMMENTS, "comments");
		record1.addFieldValue(Field.Cases.SOLUTION, "Solution for problem");
		...
		fileDetail1.setFileId("ae9c7cefa418aec1d6a5cc2d9ab35c32a6ae23d729ad8");
		fileDetails.add(fileDetail1);
		FileDetails fileDetail2 = new FileDetails();
		fileDetail2.setFileId("ae9c7cefa418aec1d6a5cc2d9ab35c32e0063e7321b52");
