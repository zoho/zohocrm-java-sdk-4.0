...
public class Deals {
	public static void createDeals(String module) throws Exception
	{
		...
		record1.addFieldValue(Field.Deals.DEAL_NAME, "deal_name");
		record1.addFieldValue(Field.Deals.AMOUNT, 100.0);
		record1.addFieldValue(Field.Deals.CLOSING_DATE, LocalDate.of(2023, 12, 12));
		com.zoho.crm.api.record.Record account = new com.zoho.crm.api.record.Record();
		account.setId(31212001L);
		record1.addFieldValue(Field.Deals.ACCOUNT_NAME, account);
		record1.addFieldValue(Field.Deals.STAGE, new Choice<String>("Qualification"));
		record1.addFieldValue(Field.Deals.PROBABILITY, 10);
		record1.addFieldValue(Field.Deals.TYPE, new Choice<String>("New Business"));
		record1.addFieldValue(Field.Deals.NEXT_STEP, null);
		record1.addFieldValue(Field.Deals.LEAD_SOURCE, new Choice<String>("Advertisement"));
		com.zoho.crm.api.record.Record contactName = new com.zoho.crm.api.record.Record();
		contactName.setId(40223200342313L);
		record1.addFieldValue(Field.Deals.CONTACT_NAME, contactName);
		com.zoho.crm.api.record.Record compaign = new com.zoho.crm.api.record.Record();
		compaign.setId(322311243223L);
		record1.addFieldValue(Field.Deals.CAMPAIGN_SOURCE, compaign);
		record1.addFieldValue(Field.Deals.DESCRIPTION, "description");
		...
		fileDetail1.setFileId("ae9c7cefa418aec1d6a5cc2d9ab35c32a6ae23d729ad87c6bd44183d280");
		fileDetails.add(fileDetail1);
		FileDetails fileDetail2 = new FileDetails();
		fileDetail2.setFileId("ae9c7cefa418aec1d6a5cc2d9ab35c32e0063e7321b878a934519e6cdb2");
