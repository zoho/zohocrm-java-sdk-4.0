...
public class Accounts {
	public static void createAccounts(String module) throws Exception
	{
		RecordOperations recordOperations = new RecordOperations();
		BodyWrapper bodyWrapper = new BodyWrapper();
		List<com.zoho.crm.api.record.Record> records = new ArrayList<com.zoho.crm.api.record.Record>();
		com.zoho.crm.api.record.Record record1 = new com.zoho.crm.api.record.Record();
		record1.addFieldValue(Field.Accounts.ACCOUNT_NAME, "new Account");
		record1.addFieldValue(Field.Accounts.RATING, new Choice<String>("Active"));
		record1.addFieldValue(Field.Accounts.PHONE, "111111");
		record1.addFieldValue(Field.Accounts.ACCOUNT_SITE, "www.account.com");
		record1.addFieldValue(Field.Accounts.FAX, "fax");
		record1.addFieldValue(Field.Accounts.WEBSITE, null);
		com.zoho.crm.api.record.Record parentAccount = new com.zoho.crm.api.record.Record();
		parentAccount.setId(4230432933L);
		record1.addFieldValue(Field.Accounts.PARENT_ACCOUNT, parentAccount);
		record1.addFieldValue(Field.Accounts.ACCOUNT_NUMBER, 121121L);
		record1.addFieldValue(Field.Accounts.ACCOUNT_TYPE, new Choice<String>("Customer"));
		record1.addFieldValue(Field.Accounts.ANNUAL_REVENUE, 2121.1);
		record1.addFieldValue(Field.Accounts.EMPLOYEES, 100);
		record1.addFieldValue(Field.Accounts.INDUSTRY, new Choice<String>("Technology"));
		record1.addFieldValue(Field.Accounts.SIC_CODE, null);
		record1.addFieldValue(Field.Accounts.OWNERSHIP, new Choice<String>("Private"));
		// Address info of Account
		record1.addFieldValue(Field.Accounts.BILLING_CITY, "city");
		record1.addFieldValue(Field.Accounts.BILLING_CODE, "12345");
		record1.addFieldValue(Field.Accounts.BILLING_COUNTRY, "country");
		record1.addFieldValue(Field.Accounts.BILLING_STATE, "state");
		record1.addFieldValue(Field.Accounts.BILLING_STREET, "street");
		record1.addFieldValue(Field.Accounts.SHIPPING_CITY, "shipping city");
		record1.addFieldValue(Field.Accounts.SHIPPING_CODE, "shipping code");
		record1.addFieldValue(Field.Accounts.SHIPPING_COUNTRY, "shipping country");
		record1.addFieldValue(Field.Accounts.SHIPPING_STATE, "shipping state");
		record1.addFieldValue(Field.Accounts.SHIPPING_STREET, "shipping street");
		//
		record1.addFieldValue(Field.Accounts.DESCRIPTION, "description");
		...
		fileDetail1.setFileId("ae9c7cefa418aec1d6a5cc2d9ab35c32a6ae23db0bd44183d280");
		fileDetails.add(fileDetail1);
		FileDetails fileDetail2 = new FileDetails();
		fileDetail2.setFileId("ae9c7cefa418aec1d6a5cc2d9ab35c32e0ca878a934519e6cdb2");
