...
public class ModuleMeta extends Module implements Model
{
	 ...
	 * @return An instance of List<RelatedLists>
	 */
	public List<RelatedLists> getRelatedLists()
	{
	 ...
	 * @param relatedLists An instance of List<RelatedLists>
	 */
	public void setRelatedLists(List<RelatedLists> relatedLists)
	{
