...
import com.zoho.crm.api.customviews.SortBy;
import com.zoho.crm.api.fields.MinifiedFields;
...
public class CustomView implements Model
{
	...
	private List<MinifiedFields> fields;
	 ...
	 * @return An instance of List<MinifiedFields>
	 */
	public List<MinifiedFields> getFields()
	{
		return  this.fields;
	 ...
	 * @param fields An instance of List<MinifiedFields>
	 */
	public void setFields(List<MinifiedFields> fields)
	{
		 this.fields = fields;
