...
public class Field<T>
{
	...
	public static class Tasks
	{
		...
		public static final Field<Integer> BEST_TIME = new Field<Integer>("BEST_TIME");
	...
	public static class Data_Subject_Requests
	{
		...
		public static final Field<User> CLOSED_BY = new Field<User>("Closed_By");

		public static final Field<User> REQUESTED_BY = new Field<User>("Requested_By");
	...
	public static class Data_Enrichment_Stats__s
	{
		...
		public static final Field<Module> MODULE__S = new Field<Module>("Module__s");
	...
	public static class Calls
	{
		...
		public static final Field<Choice<String>> CALL_RESULT = new Field<Choice<String>>("Call_Result"); 
		...
		public static final Field<String> VOICE_RECORDING__S = new Field<String>("Voice_Recordings");
