...
{
	private Choice<String> timezone;
	 ...
	 */
	public Choice<String> getTimezone()
	{
	 ...
	 * @param timezone An instance of Choice<String>
	 */
	public void setTimezone(Choice<String> timezone)
	{
