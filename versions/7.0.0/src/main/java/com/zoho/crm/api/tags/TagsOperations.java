...
public class TagsOperations
{
	...
	public APIResponse<ResponseHandler> getTags(ParameterMap paramInstance) throws SDKException
	{
		...
		apiPath = apiPath.concat("/crm/v4/settings/tags");
	 ...
	 * @throws SDKException
	 */
	public APIResponse<RecordActionHandler> addTags(Long recordId, String module, NewTagRequestWrapper request, ParameterMap paramInstance) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
	 ...
	 * @throws SDKException
	 */
	public APIResponse<RecordActionHandler> removeTags(Long recordId, String module, ExistingTagRequestWrapper request) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
	 ...
	 * @throws SDKException
	 */
	public APIResponse<RecordActionHandler> addTagsToMultipleRecords(String module, NewTagRequestWrapper request, ParameterMap paramInstance) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
	 ...
	 * @throws SDKException
	 */
	public APIResponse<RecordActionHandler> removeTagsFromMultipleRecords(String module, ExistingTagRequestWrapper request, ParameterMap paramInstance) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
	...
	public static class GetTagsParam
	{
		...
		public static final Param<Boolean> MY_TAGS = new Param<Boolean>("my_tags", "com.zoho.crm.api.Tags.GetTagsParam");
