...
public class ScoringRulesOperations
{
	...
	public APIResponse<ActionHandler> createScoringRules(BodyWrapper request) throws SDKException
	{
		...
		apiPath = apiPath.concat("/crm/v4/settings/automation/scoring_rules");
	 ...
	 * @throws SDKException
	 */
	public APIResponse<ActionHandler> scoringRuleExecutionUsingLayoutId(String moduleAPIName, LayoutRequestWrapper request) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
	...
	public APIResponse<ResponseHandler> getEntityScoreRecords(ParameterMap paramInstance) throws SDKException
	{
		...
		apiPath = apiPath.concat("/crm/v4/Entity_Scores__s");
