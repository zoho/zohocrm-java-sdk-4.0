...
public class Constants
{
	...
	public static final ArrayList<String> SET_CONTENT_TYPE_HEADER = new ArrayList<String>(Arrays.asList("/crm/bulk/v4/read", "/crm/bulk/v4/write"));
	...
	public static final ArrayList<String> INIT_MANDATORY_KEYS = new ArrayList<String>(Arrays.asList(Constants.TOKEN, Constants.USER_SIGNATURE));
	...
	public static final ArrayList<String> OAUTH_TOKEN_FIELDS = new ArrayList<String>(Arrays.asList("clientID", "clientSecret", "redirectURL", "grantToken", "refreshToken", "accessToken", "expiresIn", "userSignature", "id"));
