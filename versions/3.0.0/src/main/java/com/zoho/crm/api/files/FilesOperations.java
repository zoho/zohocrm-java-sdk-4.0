...
public class FilesOperations
{
	...
	public APIResponse<ActionHandler> uploadFiles(BodyWrapper request, ParameterMap paramInstance) throws SDKException
	{
		...
		apiPath = apiPath.concat("/crm/v4/files");
	...
	{
		public static final Param<String> TYPE = new Param<String>("type", "com.zoho.crm.api.Files.UploadFilesParam");

	}

	public static class GetFileParam
	{
		public static final Param<String> ID = new Param<String>("id", "com.zoho.crm.api.Files.GetFileParam");
