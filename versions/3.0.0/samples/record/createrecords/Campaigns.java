...
public class Campaigns {
	public static void createCampaigns(String module) throws Exception 
	{
		RecordOperations recordOperations = new RecordOperations();
		BodyWrapper bodyWrapper = new BodyWrapper();
		List<com.zoho.crm.api.record.Record> records = new ArrayList<com.zoho.crm.api.record.Record>();
		com.zoho.crm.api.record.Record record1 = new com.zoho.crm.api.record.Record();
		record1.addFieldValue(Field.Campaigns.CAMPAIGN_NAME, "New Campaign");
		record1.addFieldValue(Field.Campaigns.START_DATE, LocalDate.of(2023, 12, 12));
		record1.addFieldValue(Field.Campaigns.END_DATE, LocalDate.of(2023, 12, 20));
		record1.addFieldValue(Field.Campaigns.NUM_SENT, 10L);
		record1.addFieldValue(Field.Campaigns.ACTUAL_COST, 100.0);
		record1.addFieldValue(Field.Campaigns.EXPECTED_REVENUE, 200.0);
		record1.addFieldValue(Field.Campaigns.TYPE, new Choice<String>("Webinar"));
		record1.addFieldValue(Field.Campaigns.BUDGETED_COST, 120.0);
		record1.addFieldValue(Field.Campaigns.EXPECTED_RESPONSE, 200L);
		record1.addFieldValue(Field.Campaigns.DESCRIPTION, "Description of campaign");
		record1.addFieldValue(Field.Campaigns.STATUS, new Choice<String>("Active"));
		...
		fileDetail1.setFileId("ae9c7cefa418aec1d6a5cc2d9ab35c32a6ae23d729ad87c60");
		fileDetails.add(fileDetail1);
		FileDetails fileDetail2 = new FileDetails();
		fileDetail2.setFileId("ae9c7cefa418aec1d6a5cc2d9ab35c32e0063e7321be6cdb2");
