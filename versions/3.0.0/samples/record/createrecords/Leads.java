...
public class Leads {
	public static void createLeads(String module) throws Exception
	{
		...
		record1.addFieldValue(Field.Leads.TITLE, "lead title");
		record1.addFieldValue(Field.Leads.PHONE, "11123");
		...
		record1.addFieldValue(Field.Leads.WEBSITE, null);
		record1.addFieldValue(Field.Leads.NO_OF_EMPLOYEES, 10);
		record1.addFieldValue(Field.Leads.RATING, new Choice<String>("Active"));
		record1.addFieldValue(Field.Leads.SKYPE_ID, null);
		record1.addFieldValue(Field.Leads.SECONDARY_EMAIL, "abc1@gmail.com");
		record1.addFieldValue(Field.Leads.TWITTER, null);
		// Address info of Lead
		record1.addFieldValue(Field.Leads.CITY, "City");
		record1.addFieldValue(Field.Leads.COUNTRY, "country");
		record1.addFieldValue(Field.Leads.STREET, "street");
		record1.addFieldValue(Field.Leads.STATE, "state");
		record1.addFieldValue(Field.Leads.ZIP_CODE, "501210");
		//
		record1.addFieldValue(Field.Leads.DESCRIPTION, "description");
		...
		record1.addKeyValue("Datetime", OffsetDateTime.of(2023, 11, 20, 10, 00, 01, 00, ZoneOffset.of("+05:30")));
		...
		fileDetail1.setFileId("ae9c7cefa418aec1d6a5cc2d9ab35c32a6ae23d70b0bd44183d280");
		fileDetails.add(fileDetail1);
		FileDetails fileDetail2 = new FileDetails();
		fileDetail2.setFileId("ae9c7cefa418aec1d6a5cc2d9ab35c21b5b4ca878a934519e6cdb2");
