...
import com.zoho.crm.api.backup.FileBodyWrapper;
...
public class DownloadBackedUpData
{
	public static void downloadBackedUpData(String downloadUrl, String destinationFolder) throws Exception
	{
		BackupOperations backupOperations = new BackupOperations();
		APIResponse<ResponseHandler> response = backupOperations.downloadBackedUpData(downloadUrl);
		if (response != null)
		{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			String downloadUrl = "https://download-accl.zoho.com/v2/crm/123456789/backup/36523003/Data_001.zip";
			String destinationFolder = "/Users/zohocrm-java-sdk-sample/file";
			downloadBackedUpData(downloadUrl, destinationFolder);
		}
		catch (Exception e)
		{
			e.printStackTrace();
