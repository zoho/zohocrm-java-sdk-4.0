...
public class PipelineOperations
{
	...
	public APIResponse<ResponseHandler> getPipelines() throws SDKException
	{
		...
		apiPath = apiPath.concat("/crm/v4/settings/pipeline");
	 ...
	 * @throws SDKException
	 */
	public APIResponse<TransferActionHandler> transferPipelines(TransferPipelineWrapper request) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();

		String apiPath = new String();

		apiPath = apiPath.concat("/crm/v4/settings/pipeline/actions/transfer");
