...
public class Constants
{
	...
	public static final String GET_TOKEN_BY_ID_FILE_ERROR = "Exception in getTokenById - FileStore : Given Id not found";
	...
	public static final ArrayList<String> OAUTH_MANDATORY_KEYS = new ArrayList<String>(Arrays.asList(Constants.GRANT_TOKEN, Constants.REFRESH_TOKEN, Constants.ID, Constants.ACCESS_TOKEN));
