...
public class Calls {
	public static void createCall(String moduleAPIName) throws Exception 
	{
		...
		whoId.setId(4402481030088L);
		record1.addFieldValue(Field.Calls.WHO_ID, whoId);
		com.zoho.crm.api.record.Record whatId = new com.zoho.crm.api.record.Record();
		whatId.setId(440248884001L);
		record1.addFieldValue(Field.Calls.WHAT_ID, whatId);
		...
		record1.addFieldValue(Field.Calls.CALL_AGENDA, "agenda to make call");
		record1.addKeyValue("$se_module", "Accounts");

		// log a Call
		com.zoho.crm.api.record.Record whoId1 = new com.zoho.crm.api.record.Record();
		whoId1.setId(4402481030088L);
		record1.addFieldValue(Field.Calls.WHO_ID, whoId1);
		com.zoho.crm.api.record.Record whatId1 = new com.zoho.crm.api.record.Record();
		whatId1.setId(440248884001L);
		record1.addFieldValue(Field.Calls.WHAT_ID, whatId1);
		record1.addFieldValue(Field.Calls.CALL_TYPE, new Choice<String>("Outbound"));
		record1.addFieldValue(Field.Calls.SUBJECT, "call");
		record1.addFieldValue(Field.Calls.CALL_DURATION, "10:00");
		record1.addKeyValue("Voice_Recording__s", "recordingofcall.com");
		record1.addFieldValue(Field.Calls.OUTGOING_CALL_STATUS, new Choice<String>("Completed"));
		record1.addFieldValue(Field.Calls.CALL_START_TIME, OffsetDateTime.of(2022, 11, 20, 10, 00, 01, 00, ZoneOffset.of("+05:30")));
		record1.addFieldValue(Field.Calls.CALL_PURPOSE, new Choice<String>("Demo"));
		record1.addFieldValue(Field.Calls.CALL_AGENDA, "agenda to make call");
		record1.addFieldValue(Field.Calls.CALL_RESULT, new Choice<String>("Not interested"));
		record1.addFieldValue(Field.Calls.DESCRIPTION, "desc");
		record1.addKeyValue("$se_module", "Accounts");
		//
		...
		fileDetail1.setFileId("ae9c7cefa418aec1d6a5cc2d9ab35c32a6ae23d729add280");
		fileDetails.add(fileDetail1);
		FileDetails fileDetail2 = new FileDetails();
		fileDetail2.setFileId("ae9c7cefa418aec1d6a5cc2d9ab35cca878a934519e6cdb2");
