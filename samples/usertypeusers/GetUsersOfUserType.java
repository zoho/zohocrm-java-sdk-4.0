...
import com.zoho.crm.api.usertypeusers.BodyWrapper;
...
public class GetUsersOfUserType
{
	...
	{
		UserTypeUsersOperations userTypeOperations = new UserTypeUsersOperations(userTypeId, portalName, null, null);
		APIResponse<ResponseHandler> response = userTypeOperations.getUsersOfUserType();
		if (response != null)
		{
