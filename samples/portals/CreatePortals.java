...
{
	public static void createPortals() throws Exception
	{
		...
		portal.setName("PortalsAPItest100");
		portals.add(portal);
		bodyWrapper.setPortals(portals);
		APIResponse<ActionHandler> response = portalsOperations.createPortals(bodyWrapper);
		if (response != null)
		{
