...
{
	/**
	 * <h3>Get Users</h3> This method is used to retrieve the users data specified in the API request. You can specify the type of users that needs to be retrieved using the Users API.
	 * 
	 * @throws Exception
	 */
			...
			if (response.isExpected())
			{
				...
				if (responseHandler instanceof BodyWrapper)
				{
					...
					for (com.zoho.crm.api.users.User user : users)
					{
						...
						System.out.println("User TimeZone: " + user.getTimeZone().getID());
						...
						// Get the Status of each User
						System.out.println("User Status: " + user.getCategory());
					}
	...
	/**
	 * <h3>Create Users</h3> This method is used to add a user to your organization and print the response.
	 * 
	 * @throws Exception
	 */
	public static void createUser() throws Exception
	{
		...
		role.setId(3477061268l);

		user1.setRole(role);

		user1.setFirstName("TestUser");

		user1.setEmail("javasdk@zoho.com");
	...
	/**
	 * <h3>Update Users</h3> This method is used to update the details of multiple users of your organization and print the response.
	 * 
	 * @throws Exception
	 */
...
//		user1.addKeyValue(apiName, value);
	...
	/**
	 * <h3>Get User</h3> This method is used to get the details of any specific user. Specify the unique id of the user in your API request to get the data for that particular user.
	 * 
	...
	/**
	 * <h3>Update User</h3> This method is used to update the details of a user of your organization and print the response.
	 * 
	...
	/**
	 * <h3>Delete User</h3> This method is used to delete a user from your organization and print the response.
	 * 
