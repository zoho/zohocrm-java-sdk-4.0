...
import com.zoho.crm.api.org.HierarchyPreference;
...
{
	/**
	 * <h3>Get Organization</h3> This method is used to get the organization data and print the response.
	 * 
	 * @throws Exception
	 */
			...
			if (response.isExpected())
			{
				...
				if (responseHandler instanceof ResponseWrapper)
				{
					...
					for (com.zoho.crm.api.org.Org org : orgs)
					{
						...
						HierarchyPreference hierarchyPreferences = org.getHierarchyPreferences();
	...
	/**
	 * <h3>Upload Organization Photo</h3> This method is used to upload the brand logo or image of the organization and print the response.
	 * 
