...
{
	/**
	 * <h3>Upload File</h3> This method is used to upload a CSV file in ZIP format for bulk write API. The response contains the file_id. Use this ID while making the bulk write request.
	 * 
	...
	/**
	 * <h3>Create BulkWrite Job</h3> This method is used to create a bulk write job.
	 * 
...
//		resourceIns.setModule(moduleAPIName);
	...
	/**
	 * <h3>Get BulkWriteJob Details</h3> This method is used to get the details of a bulk write job performed previously.
	 * 
	...
	/**
	 * <h3>Download BulkWrite Result</h3> This method is used to download the result of the bulk write job as a CSV file.
	 * 
	...
	{
		// example
		// String downloadUrl = "https://download-accl.zoho.com/v2/crm/6735/bulk-write/3477061229/3477061229.zip";
