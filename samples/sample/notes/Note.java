...
{
	/**
	 * <h3>Get Notes</h3> This method is used to get the list of notes and print the response.
	 * 
	 * @throws Exception
	 */
	public static void getNotes() throws Exception
	{
		...
		paramInstance.add(new Param<String>("ids", null), "347706192954");
	...
	/**
	 * <h3>Create Notes</h3> This method is used to add new notes and print the response.
	 * 
	 * @throws Exception
	 */
	public static void createNotes() throws Exception
	{
		...
		for (int i = 1; i <= 5; i++)
		{
			...
			parentRecord.setId(347706111829018l);
	...
	/**
	 * <h3>Update Notes</h3> This method is used to update an existing note and print the response.
	 * 
	 * @throws Exception
	 */
	...
	{
		// example
		// ArrayList<Long> notesId = new ArrayList<Long>(Arrays.asList(347706161531l,347706161532l));
	...
	/**
	 * <h3>Get Note</h3> This method is used to get the note and print the response.
	 * 
	...
	/**
	 * <h3>Update Note</h3> This method is used to update an existing note and print the response.
	 * 
	 * @param noteId - The ID of the Note to be obtained
	 * @throws Exception
	 */
	public static void updateNote(Long noteId) throws Exception
	{
		...
		// Set ID of the Record
		parentRecord.setId(347706172551l);
	...
	/**
	 * <h3>Delete Note</h3> This method is used to delete single Note with ID and print the response.
	 * 
