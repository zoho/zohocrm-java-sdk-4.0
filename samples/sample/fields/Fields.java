...
{
	/**
	 * <h3>Get Fields</h3> This method is used to get metadata about all the fields of a module and print the response.
	 * 
	 * @throws Exception
				...
				if (responseHandler instanceof BodyWrapper)
				{
					...
					for (Field field : fields)
					{
						...
						if (associationDetails != null)
						{
							...
							ModuleMap lookupField = associationDetails.getLookupField();
							...
							// Get the Object obtained LookupField instance
							ModuleMap relatedField = associationDetails.getRelatedField();
						...
						MultiModuleLookupGroup multimodulelookupgroup = field.getMultiModuleLookup();

						// Check if multiModuleLookup is not null
						if (multimodulelookupgroup != null)
						{
							MultiModuleLookup multiModuleLookup = (MultiModuleLookup) multimodulelookupgroup;
							...
							for (ModuleMap module : multiModuleLookup.getModules())
							{
						...
						CurrencyGroup currencygroup = field.getCurrency();

						// Check if currencygroup is not null
						if (currencygroup != null)
						{
							Currency currency = (Currency) currencygroup;
						...
						LookupGroup lookupgroup = field.getLookup();

						// Check if lookup is not null
						if (lookupgroup != null)
						{
							Lookup lookup = (Lookup) lookupgroup;
						...
						// Get the Object obtained Module instance
						SubformGroup subformgroup = field.getSubform();

						// Check if subformgroup is not null
						if (subformgroup != null)
						{
							Subform subform = (Subform) subformgroup;
							// Get the Module of the Module
...
//								Get the Casesensitive of the Unique
						...
						if (field.getHistoryTracking() != null)
						{
							...
							ModuleMap durationConfigured = historytracking.getDurationConfiguredField();
						...
						FormulaGroup formulagroup = field.getFormula();

						// Check if formula is not null
						if (formulagroup != null)
						{
							Formula formula = (Formula) formulagroup;
						...
						MultiselectlookupGroup multiselectlookupgroup = field.getMultiselectlookup();

						// Check if formula is not null
						if (multiselectlookupgroup != null)
						{
							Multiselectlookup multiSelectLookup = (Multiselectlookup) multiselectlookupgroup;
						...
						List<PickListValuesGroup> pickListValues = field.getPickListValues();

						// Check if formula is not null
						if (pickListValues != null)
						{
							for (PickListValuesGroup pickListValue : pickListValues)
							{
								printPickListValue((PickListValue) pickListValue);
							}
						}

						// Get the AutoNumber of each Field
						AutoNumberGroup autonumbergroup = field.getAutoNumber();

						// Check if autoNumber is not null
						if (autonumbergroup != null)
						{
							AutoNumber autoNumber = (AutoNumber) autonumbergroup;
	...
	/**
	 * <h3>Get Field</h3> This method is used to get metadata about a single field of a module with fieldID and print the response.
	 * 
