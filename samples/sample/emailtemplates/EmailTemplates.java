...
public class EmailTemplates
{
			...
			if (response.isExpected())
			{
				...
				if (responseHandler instanceof ResponseWrapper)
				{
					...
					for (EmailTemplate emailTemplate : emailTemplates)
					{
						...
						MinifiedModule module = emailTemplate.getModule();
						...
						// Get the Created by
						MinifiedUser createdBy = emailTemplate.getCreatedBy();
						...
						if (createdBy != null)
						{
							...
							System.out.println("EmailTemplate Created By Email : " + createdBy.getEmail());
						...
						// Get the Modified by
						MinifiedUser modifiedBy = emailTemplate.getModifiedBy();
						...
						if (modifiedBy != null)
						{
							...
							System.out.println("EmailTemplate Modified By Email : " + modifiedBy.getEmail());
						...
						System.out.println("EmailTemplate Subject: " + emailTemplate.getCategory());
	...
	/*
	 * <h3> Get EmailTemplate</h3> This method is used to get a single Email Template
	 * 
