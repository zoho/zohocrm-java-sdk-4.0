...
import com.zoho.crm.api.pipeline.TransferActionHandler;
import com.zoho.crm.api.pipeline.TransferActionResponse;
...
import com.zoho.crm.api.pipeline.TransferSuccess;
...
{
	/*
	 * <h3> to Transfer And Delete</h3> This method is used to Transfer And Delete
	 * 
	...
	public static void TransferAndDelete(Long LayoutID) throws Exception
	{
		...
		stage.setFrom(36523976817L);

		stage.setTo(36523976819L);
		...
		APIResponse<TransferActionHandler> response = pipelineOperations.transferPipelines(request);
		...
		if (response != null)
		{
			...
			if (response.isExpected())
			{
				...
				if (transferActionHandler instanceof TransferActionHandler)
				{
					...
					for (TransferActionResponse transferPipeline1 : transferPipelines1)
					{
						...
						if (transferPipeline1 instanceof TransferSuccess)
						{
							// Get the received SuccessResponse instance
							TransferSuccess successResponse = (TransferSuccess) transferPipeline1;
	...
	/*
	 * <h3> Get Pipelines</h3> This method is used to get Pipelines
	 * 
	 * @param LayoutID The id of the Layout
	 * 
	 * @throws Exception
	...
	/*
	 * <h3> create Pipelines</h3> This method is used to create Pipelines
	 * 
	 * @param LayoutID The id of the Layout
	 * 
	 * @throws Exception
	...
	public static void createPipelines(Long LayoutID) throws Exception
	{
		...
		pipeLine.setDisplayValue("Pipeline1123");
		...
		pickListValue.setId(34770616805l);
	...
	/*
	 * <h3> update Pipelines</h3> This method is used to update Pipelines
	 * 
	 * @param LayoutID The id of the Layout
	 * 
	 * @throws Exception
	...
	public static void updatePipelines(Long LayoutID) throws Exception
	{
		...
		pickListValue.setId(34770616801l);
	...
	/*
	 * <h3> Get Pipeline</h3> This method is used to get single Pipeline
	 * 
	 * @param LayoutID The id of the Layout
	 * 
	...
	/*
	 * <h3> update Pipeline</h3> This method is used to update Pipeline
	 * 
	 * @param LayoutID The id of the Layout
	 * 
	 * @param pipelineID The id of the pipeline
	...
	public static void updatePipeline(Long LayoutID, Long pipelineID) throws Exception
	{
		...
		pipeLine.setDisplayValue("Adfasfsad112123");
