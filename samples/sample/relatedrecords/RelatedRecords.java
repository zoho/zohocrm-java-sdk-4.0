...
{
	/**
	 * <h3>Get Related Records</h3> This method is used to get the related list records and print the response.
	 * 
...
//		paramInstance.add(GetRelatedRecordsParam.FIELDS, "id");
		...
		paramInstance.add(new Param<String>("ids", null), "347706111064027");
							...
							if (value instanceof List)
							{
								...
								if (dataList.size() > 0)
								{
									...
									else if (dataList.get(0) instanceof ImageUpload)
									{
										...
										{
											System.out.println("RelatedRecord  Description: " + imageUpload.getDescription());

											System.out.println("RelatedRecord  PreviewId: " + imageUpload.getPreviewId());

											System.out.println("RelatedRecord  File_Name: " + imageUpload.getFileName());

											System.out.println("RelatedRecord  State: " + imageUpload.getState());

											System.out.println("RelatedRecord  Size: " + imageUpload.getSize());

											System.out.println("RelatedRecord  SequenceNumber: " + imageUpload.getSequenceNumber());

											System.out.println("RelatedRecord  Id: " + imageUpload.getId());

											System.out.println("RelatedRecord  FileId: " + imageUpload.getFileId());
										}
									}
	...
	/**
	 * <h3>Update Related Records</h3> This method is used to update the relation between the records and print the response.
	 * 
	...
	public static void updateRelatedRecords(String moduleAPIName, Long recordId, String relatedListAPIName) throws Exception
	{
		 ...
		 */
		record1.addKeyValue("id", 347706111064027l);
		 ...
		 * Call addKeyValue method that takes two arguments 1 -> A string that is the Field's API Name 2 -> Value
		 */
		record2.addKeyValue("id", 3477061106971l);
	...
	/**
	 * <h3>Delink Records</h3> This method is used to delete the association between modules and print the response.
	 * 
	...
	public static void delinkRecords(String moduleAPIName, Long recordId, String relatedListAPIName, List<String> relatedListIds) throws Exception
	{
		...
		// Long recordId = 347706151772l;
		// String relatedListAPIName = "Products";
		// List<String> relatedListIds = new ArrayList<String>(Arrays.asList("347706159191", "34770615917011"));
	...
	/**
	 * <h3>Get Related Records Using External Id</h3> This method is used to get the related list records and print the response.
	 * 
	 * @param moduleAPIName      - The API Name of the module to get related records.
	 * @param externalValue      -
	 * @param relatedListAPIName - The API name of the related list. To get the API name of the related list.
	 * @throws Exception
	 */
	public static void getRelatedRecordsUsingExternalId(String moduleAPIName, String externalValue, String relatedListAPIName) throws Exception
	{
		// example
		// String moduleAPIName = "Leads";
		// String externalValue = "347706151772";
		// String relatedListAPIName = "Products";
	...
	/**
	 * <h3>Update Related Records Using External Id</h3> This method is used to update the relation between the records and print the response.
	 * 
	 * @param moduleAPIName      - The API Name of the module to update related records.
	 * @param externalValue      -
	 * @param relatedListAPIName - The API name of the related list. To get the API name of the related list.
	...
	/**
	 * <h3>Delete RelatedRecords Using External Id</h3> This method is used to delete the association between modules and print the response.
	 * 
	 * @param moduleAPIName      - The API Name of the module to delink related records.
	 * @param externalValue      -
	 * @param relatedListAPIName - The API name of the related list. To get the API name of the related list.
	 ...
	 * @throws Exception
	 */
	public static void deleteRelatedRecordsUsingExternalId(String moduleAPIName, String externalValue, String relatedListAPIName, List<String> relatedListIds) throws Exception
	{
		// API Name of the module
		// String moduleAPIName = "Leads";
		// String externalValue = "347706151772";
		...
		// Call delinkRecords method that takes xExternal and paramInstance instance as parameter.
	...
	/**
	 * <h3>Get Related Record</h3> This method is used to get the single related list record and print the response.
	 * 
	...
	public static void getRelatedRecord(String moduleAPIName, Long recordId, String relatedListAPIName, Long relatedListId, String destinationFolder) throws Exception
	{
		...
		// Long recordId = 347706151772l;
		// String relatedListAPIName = "Products";
		// Long relatedListId = 34770614994115l;
	...
	/**
	 * <h3>Update Related Record</h3> This method is used to update the relation between the records and print the response.
	 * 
	...
	/**
	 * <h3>Delink Record</h3> This method is used to delete the association between modules and print the response.
	 * 
	...
	/**
	 * <h3>Get Related Record Using External Id</h3> This method is used to get the single related list record and print the response.
	 * 
	 * @param moduleAPIName      - The API Name of the module to get related record.
	 * @param externalValue      -
	 * @param relatedListAPIName - The API name of the related list. To get the API name of the related list.
	...
	/**
	 * <h3>Update Related Record Using External Id</h3> This method is used to update the relation between the records and print the response.
	 * 
	 * @param moduleAPIName      - The API Name of the module to update related record.
	 * @param externalValue      -
	 * @param relatedListAPIName - The API name of the related list. To get the API name of the related list.
	 ...
	 * @throws Exception
	 */
	public static void updateRelatedRecordUsingExternalId(String moduleAPIName, String externalValue, String relatedListAPIName, String externalFieldValue) throws Exception
	{
		// example
		// String moduleAPIName = "Leads";
		// String externalValue = "347706151772";
	...
	/**
	 * <h3>Delete Related Record Using External Id</h3> This method is used to delete the association between modules and print the response.
	 * 
	 * @param moduleAPIName      - The API Name of the module to delink related record.
	 * @param externalValue      -
	 * @param relatedListAPIName - The API name of the related list. To get the API name of the related list.
	 ...
	 * @throws Exception
	 */
	public static void deleteRelatedRecordUsingExternalId(String moduleAPIName, String externalValue, String relatedListAPIName, String externalFieldValue) throws Exception
	{
		// example
		// String moduleAPIName = "Leads";
		// String externalValue = "347706151772";
