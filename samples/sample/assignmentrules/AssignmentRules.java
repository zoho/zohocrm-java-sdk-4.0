...
{
	/*
	 * <h3> Get AssignmentRules</h3> This method is used to get assignment rules
	 * 
	 * @throws Exception
	 */
	...
	/*
	 * <h3> Get AssignmentRule</h3> This method is used to get a single assignment rule
	 * 
	 * @throws Exception
	 * 
	 * @param assignmentRuleID The id of the assignment rule
	 */
	public static void getAssignmentRule(Long assignmentRuleID, String moduleAPIName) throws Exception
	{
		// Get instance of AssignmentRulesOperations Class
		AssignmentRulesOperations assignmentRuleOperations = new AssignmentRulesOperations();
		...
		paramInstance.add(AssignmentRulesOperations.GetAssignmentRuleParam.MODULE, moduleAPIName);

		// Call getAssignmentRules method
		APIResponse<ResponseHandler> response = assignmentRuleOperations.getAssignmentRule(assignmentRuleID, paramInstance);
