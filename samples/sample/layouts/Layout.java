...
import com.zoho.crm.api.layouts.ModuleMapping;
import com.zoho.crm.api.layouts.Profile;
				...
				if (responseHandler instanceof ResponseWrapper)
				{
					...
					for (com.zoho.crm.api.layouts.Layout layout : layouts)
					{
						...
						if (layout.getConvertMapping() != null)
						{
							...
							ModuleMapping accounts = convertMapping.getAccounts();

							ModuleMapping contacts = convertMapping.getContacts();

							ModuleMapping deals = convertMapping.getDeals();
						}
