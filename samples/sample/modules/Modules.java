...
public class Modules
{
			...
			if (response.isExpected())
			{
				...
				if (responseHandler instanceof ResponseWrapper)
				{
					...
					for (Module module : modules)
					{
						...
						MinifiedModuleGroup parentModule = module.getParentModule();

						// Check if arguments is not null
						if (parentModule != null && ((MinifiedModule) parentModule).getAPIName() != null)
						{
							// Get the Name of Parent Module
							System.out.println("Module Parent Module Name: " + ((MinifiedModule) parentModule).getAPIName());

							// Get the Value of Parent Module
							System.out.println("Module Parent Module Id: " + ((MinifiedModule) parentModule).getId());
						}
					}
				}
	...
	public static void getModuleByAPIName(String moduleAPIName) throws Exception
	{
		...
		// Call getModuleByAPIName method that takes moduleAPIName as parameter
		APIResponse<SingleResponseHandler> response = moduleOperations.getModuleByAPIName(moduleAPIName);
		...
		if (response != null)
		{
			...
			if (response.isExpected())
			{
				...
				{
					// Get the received SingleResponseWrapper instance
	...
	public static void updateModuleByAPIName(String moduleAPIName) throws Exception
	{
		...
		List<ModuleMeta> modules = new ArrayList<ModuleMeta>();
